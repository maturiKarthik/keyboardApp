...
@Database(entities = arrayOf(Programs::class), version = 2)
...
class RoomDatabaseHelper {
    ...
    companion object {
        ...
        private fun build(context: Context): RoomDatabaseHelper {
            val db =
                Room.databaseBuilder(context, AppDatabase::class.java, "keyboard-shortcuts").fallbackToDestructiveMigration()
